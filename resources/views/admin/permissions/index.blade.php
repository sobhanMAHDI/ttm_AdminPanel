        ...
        <div class="card-header mt-6">
            ...
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1 me-5">
                    ...
                    <input type="search" class="form-control form-control-solid w-250px ps-14"
                        name="search" required placeholder="نام دسترسی را جستجو کنید" style="padding: 20px 0;">
            ...
            <div class="card-toolbar">
                <a href="{{ route('admin.permission.create') }}" class="btn btn-primary">
                                    ...
                                    {{ __('home.permission.permission_btn') }}
                                </a>
            </div>
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-250px sorting_disabled" rowspan="1" colspan="1"
                                    aria-label="Assigned to" style="width: 432.484px;">Assigned to</th>
                                <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_permissions_table"
                                    rowspan="1" colspan="1"
                                    aria-label="Created Date: activate to sort column ascending" style="width: 131.719px;">
                                    Created Date</th>
                                ...
                                @foreach ($permissions as $permission)
                                    ...
                                    <td>
                                        @foreach ($permission->roles as $role)
                                            <a class="badge badge-light-danger fs-7 m-1" href="{{ route('admin.role.show',$role->id) }}"
                                                class="badge badge-primary fs-7 m-1">{{ $role->name }}</a>
                                        @endforeach

                                    </td>
                                    <td>
                                        {{ \Morilog\Jalali\Jalalian::fromDateTime( $permission->created_at)->format('d/m/Y') }}
                                    </td>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                            ...
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a onclick="return confirm('آیا این دسترسی حذف شود ؟')" href="{{ route('admin.permission.delete', $permission->id) }}" class="menu-link px-3"
