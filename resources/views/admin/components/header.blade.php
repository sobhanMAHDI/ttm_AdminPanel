    ...
    <div id="kt_header" style="" class="header align-items-stretch">
        ...
        <div class="container-fluid d-flex align-items-stretch justify-content-between">
            ...
            <div class="d-flex align-items-center d-lg-none ms-n3 me-1" title="Show aside menu">
                <div class="btn btn-icon btn-light-primary w-30px h-30px w-md-40px h-md-40px"
                        ...
                        <div class="d-flex align-items-stretch ms-1 ms-lg-3">
                            ...
                            <div id="kt_header_search" class="d-flex align-items-stretch"
                                ...
                                <div class="d-flex align-items-center" data-kt-search-element="toggle"
                                    ...
                                    <div
                                        class="btn btn-icon btn-light-primary w-30px h-30px w-md-40px h-md-40px">
...
-->
                                    ...
                                    <form data-kt-search-element="advanced-options-form" class="pt-1 d-none">
                                        ...
                                        <div class="d-flex justify-content-end">
                                            <button type="reset"
                                                class="btn btn-sm btn-light fw-bolder btn-light-primary me-2"
                        ...
                        <div class="d-flex align-items-center ms-1 ms-lg-3">
                            <!--begin::Menu- wrapper-->
                            <div class="btn btn-icon btn-light-primary position-relative w-30px h-30px w-md-40px h-md-40px"
                        ...
                        <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px"
                                ...
                                <div class="menu-item px-5" data-kt-menu-trigger="hover"
                                    data-kt-menu-placement="left-start">
                                    <a href="#" class="menu-link px-5">
                                        <span class="menu-title position-relative">{{ __('home.header.Language') }}
                                            <span
                                                ...
                                                @if (app()->getLocale() == 'English')
                                                    ...
                                                    <img class="w-15px h-15px rounded-1 ms-2"
                                                        ...
                                                        alt="" />
                                                @elseif (app()->getLocale() == 'Persian')
                                                    Persian
                                                    <img class="w-15px h-15px rounded-1 ms-2"
                                                        src="{{ asset('assets/media/flags/iran.svg') }}"
                                                        alt="" />
                                                @endif
                                            </span></span>
                                    </a>
                                ...
                                <div class="menu-item px-5">
                                    <a href="{{ route('admin.logout') }}"
                                        onclick="event.preventDefault();document.getElementById('logout_handler').submit();"
                                        class="menu-link px-5">{{ __('home.header.SignOut') }}</a>
                                    <form action="{{ route('admin.logout') }}" id="logout_handler"
