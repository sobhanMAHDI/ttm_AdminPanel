    ...
    <div class="card mb-5 mb-xl-10 mx-5 shadow-lg">
        ...
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
            ...
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0">{{ __('home.role.Add_New_Role') }}</h3>
            </div>
            <!--end::Card title-->
        </div>
        <!--begin::Card header-->
        ...
        <div id="kt_account_profile_details" class="collapse show">
            <form class="form fv-plugins-bootstrap5 fv-plugins-framework" action="{{ route('admin.role.store') }}"
                method="POST">
                @csrf
                    ...
                    <div class="row mb-6">
                        <label class="col-lg-4 col-form-label fw-bold fs-6">
                            ...
                            <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title=""
                                data-bs-original-title="select the permission for this role" aria-label="Country of origination"></i>
                        </label>
